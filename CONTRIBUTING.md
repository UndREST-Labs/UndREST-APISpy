...
## 🧱 Generated Artefact Ownership (Do Not Hand-Edit)

The following files are generated by scripts/workflows and are committed for
offline extension use. Treat them as pipeline-owned artefacts:
...
- `extension/data/azure-provider-ops.json` — generated by `scripts/prepare_provider_ops.py`
- `demos/apispy-*.png` — generated by `scripts/generate_screenshots.py`, updated by `update-screenshots.yml`

Do not hand-edit these files. Regenerate them through their owning pipeline/script
